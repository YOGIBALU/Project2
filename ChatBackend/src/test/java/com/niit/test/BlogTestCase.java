...
public class BlogTestCase 
{
	...
	{
		assertTrue("Problem in Approving Blog",blogDAO.approveBlog(-26));
	}
	
	@Test
	public void rejectBlogTestCase()
	{
		assertTrue("Problem in Rejecting Blog",blogDAO.rejectBlog(-26));
	}
	@Test
	public void incrementLikesBlogTestCase()
	{
		assertTrue("Problem in incrementing likes",blogDAO.incLikes(-26));
	}
	
	@Test
	public void disLikesBlogTestCase()
	{
		assertTrue("Problem in incrementing dislikes",blogDAO.disLikes(-26));
	}
