...
public class ForumTestCase
{
	...
	{
		Forum forum = forumDAO.getForum(-26);
	...
	{
		Forum forum = forumDAO.getForum(-27);
	...
	{
		assertTrue("Problem in Approving Forum", forumDAO.approveForum(-28));
	}
	
	@Test
	public void rejectForumTestCase()
	{
		assertTrue("Problem in Rejecting Forum", forumDAO.rejectForum(-27));
	}
}
